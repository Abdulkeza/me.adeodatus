 ...
 */
package it.codeland.unicredit_magazine.core.models;
...
import it.codeland.unicredit_magazine.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "unicredit_magazine/components/helloworld");
